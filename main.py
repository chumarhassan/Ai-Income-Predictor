...
def create_input_field(label_text, row, field_name, field_type):
    ...
    content_frame.pack(fill="x", expand=True, pady=(5, 5))
...
tk.Label(app, text="AI Project by Zubaria & Umar", bg=COLOR_GEMINI_BACKGROUND_PRIMARY, fg=COLOR_GEMINI_TEXT_SECONDARY, font=FONT_DESCRIPTION).pack(side="bottom", pady=(5, 15))
app.mainloop()